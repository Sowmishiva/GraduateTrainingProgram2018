...
SELECT R.ROOM_NO,H.NAME FROM HOTEL H INNER JOIN ROOM R ON R.HOTEL_NO=H.HOTEL_NO WHERE R.ROOM_NO NOT IN(SELECT ROOM_NO FROM BOOKING);
257|CLAIRMONT HOTEL
313|EMPIRE HOTEL
...
SELECT AVG(PRICE),H.CITY FROM HOTEL H INNER JOIN ROOM R ON H.HOTEL_NO=R.HOTEL_NO GROUP BY H.CITY;
155.0|BOSTON
165.0|NEW YORK
147.0|TORONTO
RECORD COUNT:3
